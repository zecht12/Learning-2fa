        ...
        <div className="h-screen w-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-800 to-zinc-900 py-28 px-14">
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <Button asChild variant="link" size="lg" className="flex items-center justify-center">
                        <Link href="/settings/edit">
                            <p className="flex items-center justify-center">Edit Profile <IoIosArrowRoundForward size={25} />
                            </p>
                        </Link>
                    </Button>
                </CardContent>
