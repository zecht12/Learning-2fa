...
const Navbar = () => {
    ...
    return (
        <div className={color ? "fixed w-full h-20 bg-slate- shadow-xl z-[100]" : " fixed w-full shadow-xl h-20 z-[100]"}>
            <div className='flex justify-between items-center w-full h-full px-6 2xl:px-16 '>
                <div className='w-full h-full flex items-center justify-start'>
                    <Image src="" alt='logo' width={40} height={40} className='text-slate-100'/>
                </div>
                <ul>
