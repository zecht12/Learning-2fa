...
const UserEdit = () => {
    ...
    const handleFileUpload = async (event:any) => {
        ...
        if (file) {
            ...
            const response = await fetch(`https://api.cloudinary.com/v1_1/${cloudinary.config().cloudName}/upload`, {
                method: 'POST',
                body: formData
            });
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input {...field} type="file" placeholder="profile image" disabled={isPending} onChange={(e) => field.onChange(e.target.files?.[0].name)} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
