...
import { AdvancedImage, lazyload, responsive, accessibility,
placeholder } from '@cloudinary/react';
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            {field.value && (
                                                <AdvancedImage cldImg={cld.image(field.value)} plugins={[lazyload(),responsive(), accessibility(), placeholder()]} />
                                            )}
                                            <FormControl>
