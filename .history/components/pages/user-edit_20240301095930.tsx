...
const UserEdit = () => {
    ...
    return (
        <div className={`h-auto w-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] ${user?.role === "ADMIN" && user?.isOAuth === true && "w-full h-sc"} from-slate-800 to-zinc-900 py-10 flex items-center justify-center`}>
