...
const upload = new Upload({
    cloudinary,
    uploadPreset: 'your-upload-preset' // Replace 'your-upload-preset' with your actual Cloudinary upload preset name
});
...
const UserEdit = () => {
    ...
    const onSubmit = async (values: z.infer<typeof SettingsSchema>) => {
        ...
        formData.append('upload_preset', 'aoks0xlu');

        const response = await axios.post(
            'cloudinary://819397548594591:8Z0AKzNz6SS7zcxBWovC8LeShX4@ddcxyqur2',
            formData
        );
