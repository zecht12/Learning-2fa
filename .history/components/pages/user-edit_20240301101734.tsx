...
const UserEdit = () => {
    ...
    return (
        <div className={`bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] ${user?.role === "USER" && user?.isOAuth === true && "w-full h-screen"} ${user?.role === "USER" && user?.isOAuth === false && "w-full h-auto"} ${user?.role === "ADMIN" && user?.isOAuth === true && "w-full h-screen"} ${user?.role === "ADMIN" && user?.isOAuth === false && "w-full h-auto"}from-slate-800 to-zinc-900 py-10 flex items-center justify-center`}>
                                ...
                                <CldUploadButton uploadPreset="aoks0xlu" className={`relative h-[300px] w-full`} onUpload={handleImageUpload}>
                                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-8">
                                        {imageUrl ? (
                                            ...
                                            <>
                                                <div className="cursor-default flex flex-col items-center justify-center gap-4">
                                                    <GrCloudUpload size={30} />
                                                    <p className="text-gra text-lg">
                                                        Drag photo here
                                                    </p>
                                                </div>
