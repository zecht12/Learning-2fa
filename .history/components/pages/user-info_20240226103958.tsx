    ...
    return (
        ...
        <Card className='w-[600px]'>
            ...
            <CardContent className="space-y-2">
                <div className="flex items-center justify-center rounded-lg p->
                    <Image width="50" height="50"  className="rounded-full w-40 h-40" src={user?.image || '/images/placeholder.jpg'} alt={user?.name??""} />
                </div>
                ...
                <div className="flex items-center justify-center">
                    <Button asChild variant="default" size="sm">
                        <Link href="/settings/edit" className='font-semibold'>
                            Edit Your Profile
                        </Link>
                    </Button>
                </div>
