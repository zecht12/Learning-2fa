...
const Navbar = () => {
    ...
    return (
        <div className=" fixed w-full shadow-lg shadow-slate-600 bg-zinc-200 h-20 z-[100]">
            <div className='flex justify-between items-center w-full h-full px-6 2xl:px-16 '>
                <div className='flex items-center justify-start'>
                    ...
                    {!settings && (
                        <Link href="/home">
                            <Image src="/images/logo.jpg" alt="image" width={40} height={40} className='rounded-full shadow-lg shadow-neutral-500' />
                        </Link>
                    )}
                </div>
                <div className='flex items-center gap-4'>
                    ...
                    <div className='gap-3 p-4 md:py-1 md:px-2 border-[1px] border-neutral-300 rounded-full bg-slate-100 flex justify-around items-center shadow-sm shadow-neutral-500'>
