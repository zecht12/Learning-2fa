            ...
            <div className='flex justify-between items-center w-full h-full px-6 2xl:px-16 '>
                ...
                <div>
                    <div className="relative">
                        <AiOutlineMenu size={35} onClick={toggleMenu} className="cursor-pointer text-black hover:text-blue-600" />
                        {menuOpen && (
                            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg z-10">
                                {/* Place your menu items here */}
                                <div className="p-2">Menu Item 1</div>
                                <div className="p-2">Menu Item 2</div>
                                <div className="p-2">Menu Item 3</div>
                            </div>
                        )}
                    </div>
                </div>
