    ...
    return (
        <div className={color ? "fixed w-full h-20 bg-slate-100 shadow-xl z-[100]" : " fixed w-full shadow-xl h-20 z-[100]"}>
            <div className='flex justify-between items-center w-full h-full px-6 2xl:px-16 '>
                ...
                <div className={color ? "relative w-full h-20 bg-slate-100 shadow-xl z-[100]" : " relative w-full shadow-xl h-20 z-[100]"}>
                    <AiOutlineMenu size={25} onClick={toggleMenu} className={color?"text-black hover:text-blue-600 cursor-pointer": "text-slate-100 hover:text-blue-600 cursor-pointer"} />
                    {menuOpen && (
