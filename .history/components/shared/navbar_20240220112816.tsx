    ...
    return (
        <div className={color ? "fixed w-full h-20 bg-slate-100 shadow-xl z-[100]" : " fixed w-full shadow-xl h-20 z-[100]"}>
            <div className='flex justify-between items-center w-full h-full px-6 2xl:px-16 '>
                ...
                <div className={color?'w-50 p-2 rounded-lg bg-black flex justify-around items-center':'w-50 h-10 p-2 rounded-lg bg-slate-100 flex justify-around items-center'}>
