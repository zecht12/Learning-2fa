    ...
    return (
        <div className=" fixed w-full shadow-lg shadow-slate-700 bg-slate-200 h-20 z-[100]">
            <div className='flex justify-between items-center w-full h-full px-6 2xl:px-16 '>
                ...
                <div className='gap-3 p-4 md:py-1 md:px-2 border-[1px] border-neutral-500 rounded-full bg-slate-100 flex justify-around items-center shadow-md shadow-slate-500'>
