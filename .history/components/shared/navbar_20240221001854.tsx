        ...
        <div className=" fixed w-full shadow-xl shadow-slate-600 bg-zinc-200 h-20 z-[100]">
            <div className='flex justify-between items-center w-full h-full px-6 2xl:px-16 '>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <div className='gap-3 px-2 py-1 md:py-1 md:px-2 border-[1px] border-neutral-300 rounded-full bg-slate-100 flex justify-around items-center shadow-sm shadow-neutral-500'>
