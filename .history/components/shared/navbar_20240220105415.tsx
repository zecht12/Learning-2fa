            ...
            <div className='flex justify-between items-center w-full h-full px-6 2xl:px-16 '>
                ...
                <div>
                    <div className="relative">
                        <AiOutlineMenu size={35} onClick={toggleMenu} className={color?"text-black hover:text-blue-600 cursor-pointer": "text-slate-100 hover:text-blue-600 cursor-pointer"} />
                        {menuOpen && (
                            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg z-10">
                                <Button asChild variant="destructive" size="sm" className='flex justify-center items-center'>
