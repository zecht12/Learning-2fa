...
const Navbar = () => {
    ...
    return (
        <div className=" fixed w-full shadow-lg shadow-slate-600 bg-zinc-1200 h-20 z-[100]">
            <div className='flex justify-between items-center w-full h-full px-6 2xl:px-16 '>
                <div className='flex items-center justify-start'>
                    ...
                    {!settings && (
                        <Link href="/home">
                            <Image src="/images/logo.jpg" alt="image" width={40} height={40} className='rounded-full shadow-md shadow-neutral-500' />
                        </Link>
                    )}
                </div>
